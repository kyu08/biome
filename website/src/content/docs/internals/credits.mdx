...
- [`crates/rome_js_parser`](https://github.com/biomejs/biome/tree/main/crates/rome_js_parser)
  - **Original**: [`rslint/rslint_parser`](https://github.com/rslint/rslint/tree/master/crates/rslint_parser)
  - **License**: MIT

- [`crates/rome_js_parser/lexer`](https://github.com/biomejs/biome/tree/main/crates/rome_js_parser/src/lexer)
...
- [`crates/rome_service/src/ignore/pattern`](https://github.com/biomejs/biome/tree/main/crates/rome_service/src/ignore/pattern)
